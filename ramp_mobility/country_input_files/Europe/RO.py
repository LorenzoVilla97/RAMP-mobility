...
Working_EV_large_wd = Working_L.Appliance(Working_L, n = 1, Par_power = Par_P_EV['large'], Battery_cap = Battery_cap['large'], P_var = P_var, w = 2, d_tot = d_tot['weekday']*perc_usage['weekday']['working']['main'], fw_type = 'main', r_d = r_d, t_func = t_func['weekday']['business'], r_v = r_v, d_min = d_min['weekday']['business'], fixed = 'no', fixed_cycle = 0, occasional_use = occasional_use['weekday'], flat = 'no', pref_index = 0, wd_we_type = 0, P_series = False)
...
Working_EV_large_sat = Working_L.Appliance(Working_L, n = 1, Par_power = Par_P_EV['large'], Battery_cap = Battery_cap['large'], P_var = P_var, w = 1, d_tot = d_tot['saturday']*perc_usage['saturday']['inactive']['main'], fw_type = 'main', r_d = r_d, t_func = t_func['saturday']['business'], r_v = r_v, d_min = d_min['saturday']['business'], fixed = 'no', fixed_cycle = 0, occasional_use = occasional_use['saturday'], flat = 'no', pref_index = 0, wd_we_type = 1, P_series = False)
Working_EV_large_sat.windows(w1 = window['inactive']['main'][0],  r_w = r_w['inactive'])

# Working - Large Car - Saturday - Free Time
Working_EV_large_sat_ft = Working_L.Appliance(Working_L, n = 1, Par_power = Par_P_EV['large'], Battery_cap = Battery_cap['large'], P_var = P_var, w = 2, d_tot = d_tot['saturday']*perc_usage['saturday']['inactive']['free time'], fw_type = 'free time', r_d = r_d, t_func = t_func['saturday']['personal'], r_v = r_v, d_min = d_min['saturday']['personal'], fixed = 'no', fixed_cycle = 0, occasional_use = occasional_use['free time']['weekend'], flat = 'no', pref_index = 0, wd_we_type = 1, P_series = False)
...
Working_EV_medium_wd = Working_M.Appliance(Working_M, n = 1, Par_power = Par_P_EV['medium'], Battery_cap = Battery_cap['medium'], P_var = P_var, w = 2, d_tot = d_tot['weekday']*perc_usage['weekday']['working']['main'], fw_type = 'main', r_d = r_d, t_func = t_func['weekday']['business'], r_v = r_v, d_min = d_min['weekday']['business'], fixed = 'no', fixed_cycle = 0, occasional_use = occasional_use['weekday'], flat = 'no', pref_index = 0, wd_we_type = 0, P_series = False)
...
Working_EV_small_wd = Working_S.Appliance(Working_S, n = 1, Par_power = Par_P_EV['small'], Battery_cap = Battery_cap['small'], P_var = P_var, w = 2, d_tot = d_tot['weekday']*perc_usage['weekday']['working']['main'], fw_type = 'main', r_d = r_d, t_func = t_func['weekday']['business'], r_v = r_v, d_min = d_min['weekday']['business'], fixed = 'no', fixed_cycle = 0, occasional_use = occasional_use['weekday'], flat = 'no', pref_index = 0, wd_we_type = 0, P_series = False)
...
Working_EV_small_sat = Working_S.Appliance(Working_S, n = 1, Par_power = Par_P_EV['small'], Battery_cap = Battery_cap['small'], P_var = P_var, w = 1, d_tot = d_tot['saturday']*perc_usage['saturday']['inactive']['main'], fw_type = 'main', r_d = r_d, t_func = t_func['saturday']['business'], r_v = r_v, d_min = d_min['saturday']['business'], fixed = 'no', fixed_cycle = 0, occasional_use = occasional_use['saturday'], flat = 'no', pref_index = 0, wd_we_type = 1, P_series = False)
Working_EV_small_sat.windows(w1 = window['inactive']['main'][0], r_w = r_w['inactive'])

# Working - Small Car - Saturday - Free Time
Working_EV_small_sat_ft = Working_S.Appliance(Working_S, n = 1, Par_power = Par_P_EV['small'], Battery_cap = Battery_cap['small'], P_var = P_var, w = 2, d_tot = d_tot['saturday']*perc_usage['saturday']['inactive']['free time'], fw_type = 'free time', r_d = r_d, t_func = t_func['saturday']['personal'], r_v = r_v, d_min = d_min['saturday']['personal'], fixed = 'no', fixed_cycle = 0, occasional_use = occasional_use['free time']['weekend'], flat = 'no', pref_index = 0, wd_we_type = 1, P_series = False)
...
Student_EV_large_wd = Student_L.Appliance(Student_L, n = 1, Par_power = Par_P_EV['large'], Battery_cap = Battery_cap['large'], P_var = P_var, w = 2, d_tot = d_tot['weekday']*perc_usage['weekday']['student']['main'], fw_type = 'main', r_d = r_d, t_func = t_func['weekday']['mean'], r_v = r_v, d_min = d_min['weekday']['mean'], fixed = 'no', fixed_cycle = 0, occasional_use = occasional_use['weekday'], flat = 'no', pref_index = 0, wd_we_type = 0, P_series = False)
...
Student_EV_large_sat = Student_L.Appliance(Student_L, n = 1, Par_power = Par_P_EV['large'], Battery_cap = Battery_cap['large'], P_var = P_var, w = 1, d_tot = d_tot['saturday']*perc_usage['saturday']['inactive']['main'], fw_type = 'main', r_d = r_d, t_func = t_func['saturday']['mean'], r_v = r_v, d_min = d_min['saturday']['mean'], fixed = 'no', fixed_cycle = 0, occasional_use = occasional_use['saturday'], flat = 'no', pref_index = 0, wd_we_type = 1, P_series = False)
Student_EV_large_sat.windows(w1 = window['inactive']['main'][0], r_w = r_w['inactive'])

# Student - Large Car - Saturday - Free Time
Student_EV_large_sat_ft = Student_L.Appliance(Student_L, n = 1, Par_power = Par_P_EV['large'], Battery_cap = Battery_cap['large'], P_var = P_var, w = 2, d_tot = d_tot['saturday']*perc_usage['saturday']['inactive']['free time'], fw_type = 'free time', r_d = r_d, t_func = t_func['saturday']['personal'], r_v = r_v, d_min = d_min['saturday']['personal'], fixed = 'no', fixed_cycle = 0, occasional_use = occasional_use['free time']['weekend'], flat = 'no', pref_index = 0, wd_we_type = 1, P_series = False)
...
Student_EV_medium_wd = Student_M.Appliance(Student_M, n = 1, Par_power = Par_P_EV['medium'], Battery_cap = Battery_cap['medium'], P_var = P_var, w = 2, d_tot = d_tot['weekday']*perc_usage['weekday']['student']['main'], fw_type = 'main', r_d = r_d, t_func = t_func['weekday']['mean'], r_v = r_v, d_min = d_min['weekday']['mean'], fixed = 'no', fixed_cycle = 0, occasional_use = occasional_use['weekday'], flat = 'no', pref_index = 0, wd_we_type = 0, P_series = False)
...
Student_EV_medium_sat = Student_M.Appliance(Student_M, n = 1, Par_power = Par_P_EV['medium'], Battery_cap = Battery_cap['medium'], P_var = P_var, w = 1, d_tot = d_tot['saturday']*perc_usage['saturday']['inactive']['main'], fw_type = 'main', r_d = r_d, t_func = t_func['saturday']['mean'], r_v = r_v, d_min = d_min['saturday']['mean'], fixed = 'no', fixed_cycle = 0, occasional_use = occasional_use['saturday'], flat = 'no', pref_index = 0, wd_we_type = 1, P_series = False)
...
Student_EV_small_wd = Student_S.Appliance(Student_S, n = 1, Par_power = Par_P_EV['small'], Battery_cap = Battery_cap['small'], P_var = P_var, w = 2, d_tot = d_tot['weekday']*perc_usage['weekday']['student']['main'], fw_type = 'main', r_d = r_d, t_func = t_func['weekday']['mean'], r_v = r_v, d_min = d_min['weekday']['mean'], fixed = 'no', fixed_cycle = 0, occasional_use = occasional_use['weekday'], flat = 'no', pref_index = 0, wd_we_type = 0, P_series = False)
...
Student_EV_small_sat = Student_S.Appliance(Student_S, n = 1, Par_power = Par_P_EV['small'], Battery_cap = Battery_cap['small'], P_var = P_var, w = 1, d_tot = d_tot['saturday']*perc_usage['saturday']['inactive']['main'], fw_type = 'main', r_d = r_d, t_func = t_func['saturday']['mean'], r_v = r_v, d_min = d_min['saturday']['mean'], fixed = 'no', fixed_cycle = 0, occasional_use = occasional_use['saturday'], flat = 'no', pref_index = 0, wd_we_type = 1, P_series = False)
Student_EV_small_sat.windows(w1 = window['inactive']['main'][0], r_w = r_w['inactive'])

# Student - Small Car - Saturday - Free Time
Student_EV_small_sat_ft = Student_S.Appliance(Student_S, n = 1, Par_power = Par_P_EV['small'], Battery_cap = Battery_cap['small'], P_var = P_var, w = 2, d_tot = d_tot['saturday']*perc_usage['saturday']['inactive']['free time'], fw_type = 'free time', r_d = r_d, t_func = t_func['saturday']['personal'], r_v = r_v, d_min = d_min['saturday']['personal'], fixed = 'no', fixed_cycle = 0, occasional_use = occasional_use['free time']['weekend'], flat = 'no', pref_index = 0, wd_we_type = 1, P_series = False)
...
Inactive_EV_large_wd = Inactive_L.Appliance(Inactive_L, n = 1, Par_power = Par_P_EV['large'], Battery_cap = Battery_cap['large'], P_var = P_var, w = 1, d_tot = d_tot['weekday']*perc_usage['weekday']['inactive']['main'], fw_type = 'main', r_d = r_d, t_func = t_func['weekday']['personal'], r_v = r_v, d_min = d_min['weekday']['personal'], fixed = 'no', fixed_cycle = 0, occasional_use = occasional_use['weekday'], flat = 'no', pref_index = 0, wd_we_type = 0, P_series = False)
Inactive_EV_large_wd.windows(w1 = window['inactive']['main'][0], r_w = r_w['inactive'])

# Inactive - Large Car - Weekday - Free Time
Inactive_EV_large_wd_ft = Inactive_L.Appliance(Inactive_L, n = 1, Par_power = Par_P_EV['large'], Battery_cap = Battery_cap['large'], P_var = P_var, w = 2, d_tot = d_tot['weekday']*perc_usage['weekday']['inactive']['free time'], fw_type = 'free time', r_d = r_d, t_func = t_func['weekday']['personal'], r_v = r_v, d_min = d_min['weekday']['personal'], fixed = 'no', fixed_cycle = 0, occasional_use = occasional_use['free time']['weekday'], flat = 'no', pref_index = 0, wd_we_type = 0, P_series = False)
...
Inactive_EV_large_sat = Inactive_L.Appliance(Inactive_L, n = 1, Par_power = Par_P_EV['large'], Battery_cap = Battery_cap['large'], P_var = P_var, w = 1, d_tot = d_tot['saturday']*perc_usage['saturday']['inactive']['main'], fw_type = 'main', r_d = r_d, t_func = t_func['saturday']['personal'], r_v = r_v, d_min = d_min['saturday']['personal'], fixed = 'no', fixed_cycle = 0, occasional_use = occasional_use['saturday'], flat = 'no', pref_index = 0, wd_we_type = 1, P_series = False)
Inactive_EV_large_sat.windows(w1 = window['inactive']['main'][0], r_w = r_w['inactive'])

# Inactive - Large Car - Saturday - Free Time
Inactive_EV_large_sat_ft = Inactive_L.Appliance(Inactive_L, n = 1, Par_power = Par_P_EV['large'], Battery_cap = Battery_cap['large'], P_var = P_var, w = 2, d_tot = d_tot['saturday']*perc_usage['saturday']['inactive']['free time'], fw_type = 'free time', r_d = r_d, t_func = t_func['saturday']['personal'], r_v = r_v, d_min = d_min['saturday']['personal'], fixed = 'no', fixed_cycle = 0, occasional_use = occasional_use['free time']['weekend'], flat = 'no', pref_index = 0, wd_we_type = 1, P_series = False)
...
Inactive_EV_medium_sat = Inactive_M.Appliance(Inactive_M, n = 1, Par_power = Par_P_EV['medium'], Battery_cap = Battery_cap['medium'], P_var = P_var, w = 1, d_tot = d_tot['saturday']*perc_usage['saturday']['inactive']['main'], fw_type = 'main', r_d = r_d, t_func = t_func['saturday']['personal'], r_v = r_v, d_min = d_min['saturday']['personal'], fixed = 'no', fixed_cycle = 0, occasional_use = occasional_use['saturday'], flat = 'no', pref_index = 0, wd_we_type = 1, P_series = False)
...
Inactive_EV_small_wd = Inactive_S.Appliance(Inactive_S, n = 1, Par_power = Par_P_EV['small'], Battery_cap = Battery_cap['small'], P_var = P_var, w = 1, d_tot = d_tot['weekday']*perc_usage['weekday']['inactive']['main'], fw_type = 'main', r_d = r_d, t_func = t_func['weekday']['personal'], r_v = r_v, d_min = d_min['weekday']['personal'], fixed = 'no', fixed_cycle = 0, occasional_use = occasional_use['weekday'], flat = 'no', pref_index = 0, wd_we_type = 0, P_series = False)
Inactive_EV_small_wd.windows(w1 = window['inactive']['main'][0], r_w = r_w['inactive'])

# Inactive - Small Car - Weekday - Free Time
Inactive_EV_small_wd_ft = Inactive_S.Appliance(Inactive_S, n = 1, Par_power = Par_P_EV['small'], Battery_cap = Battery_cap['small'], P_var = P_var, w = 2, d_tot = d_tot['weekday']*perc_usage['weekday']['inactive']['free time'], fw_type = 'free time', r_d = r_d, t_func = t_func['weekday']['personal'], r_v = r_v, d_min = d_min['weekday']['personal'], fixed = 'no', fixed_cycle = 0, occasional_use = occasional_use['free time']['weekday'], flat = 'no', pref_index = 0, wd_we_type = 0, P_series = False)
...
Inactive_EV_small_sat = Inactive_S.Appliance(Inactive_S, n = 1, Par_power = Par_P_EV['small'], Battery_cap = Battery_cap['small'], P_var = P_var, w = 1, d_tot = d_tot['saturday']*perc_usage['saturday']['inactive']['main'], fw_type = 'main', r_d = r_d, t_func = t_func['saturday']['personal'], r_v = r_v, d_min = d_min['saturday']['personal'], fixed = 'no', fixed_cycle = 0, occasional_use = occasional_use['saturday'], flat = 'no', pref_index = 0, wd_we_type = 1, P_series = False)
Inactive_EV_small_sat.windows(w1 = window['inactive']['main'][0], r_w = r_w['inactive'])

# Inactive - Small Car - Saturday - Free Time
Inactive_EV_small_sat_ft = Inactive_S.Appliance(Inactive_S, n = 1, Par_power = Par_P_EV['small'], Battery_cap = Battery_cap['small'], P_var = P_var, w = 2, d_tot = d_tot['saturday']*perc_usage['saturday']['inactive']['free time'], fw_type = 'free time', r_d = r_d, t_func = t_func['saturday']['personal'], r_v = r_v, d_min = d_min['saturday']['personal'], fixed = 'no', fixed_cycle = 0, occasional_use = occasional_use['free time']['weekend'], flat = 'no', pref_index = 0, wd_we_type = 0, P_series = False)
